                                                ...
                                                {day.events.map((event) => (
                                                    <div key={event.id}>
                                                        ...
                                                        <div className="flex items-center gap-2 mb-1">
                                                            ...
                                                            />
                                                            <span className="text-[12px] text-slate-500">{timeRange(event)}</span>
                                                        </div>

                                                        {/* 이벤트 타이틀을 체크리스트 스타일로 (UI만) */}
                                                        <div className="pl-4">
                                                            <div className="flex items-start gap-2">
                                                                <span className="mt-1 inline-block w-3 h-3 rounded-sm border border-slate-300"></span>
                                                                <span className="text-[14px] text-slate-800">{event.title}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ))}
